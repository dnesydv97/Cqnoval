...
const TenderDetailScreen = () => {
      ...
      .then((response) => {
        ...
        response[0].data.map((group) => {
          if(group.isMultipleValuedAllowed)
            tempSecondaryLabelGroup.push(getTenderDetail(group, tenderId));
          else tempSecondaryLabelGroup.push(getTenderDetail(group, tenderId));
        });
  ...
  const submitNewTender = (isUpdate = false) => {
    ...
    isUpdate
      ...
      : addTenderReference(data)
        ...
        .catch((error) => {
          setLoading(false);
          showFailToast('Failed to add Tender from second if else');
          onError(error);
        });
  };
  ...
  const onTenderExtensionPressed = () => {
    navigateToGivenScreenWithParams(
        ...
        {tenderRef: tenderDetail, tenderRefCode: tenderDetail.referenceCode}
    );
  };
  ...
  return(
    <BaseContainer
      ...
      loading={loading}
      scrollable>
      {/* {console.log("Tender Id from Tender Detail", tenderId)} */}
      ...
      {!editMode && (<View style={styles.rowContainer}>
        ...
        {!editMode && (<View style={styles.rowContainer}>
          ...
          <View style={{width: '50%'}}>
            <Text style={styles.rowContentText}>{`${tenderDetail?.tenderTypeName}`}</Text>
          </View>
        </View>)}
        {/* Tender Stage*/}
        {/* {!editMode && (<View style={styles.rowContainer}>
          ...
          <View style={{width: '50%'}}>
            <Text style={styles.rowContentText}>{`${tenderDetail?.tenderStageName}`}</Text>
          </View>
        </View>)} */}
        {!editMode && (<View style={styles.rowContainer}>
          <View style={{width: '50%'}}>
        ...
        {!editMode && (<View style={styles.rowContainer}>
          ...
          {/* {console.log("Tender Basic Secondary Incharge Dtossssss",tenderBasicSecondaryInchargeDtos)} */}
          <View style={{width: '50%', flex: 1, flexDirection: 'row'}}>
            {tenderDetail?.tenderBasicSecondaryInchargeDtos.map((item, index) => (
              <Text style={styles.rowContentText} key={index}>{`${item.secondaryInchargeName},`} </Text>
            ))}
          </View>
        </View>)}
        {!editMode && (<View style={styles.rowContainer}>
        ...
        {!editMode && (<View style={styles.rowContainer}>
          ...
          <View style={{width: '50%', flex: 1, flexDirection: 'row'}}>
            {tenderDetail?.documentCost!==null && (<Text style={styles.rowContentText}>{`${tenderDetail?.documentCostCurrencySymbol}. ${tenderDetail?.documentCost}`}</Text>)}
          </View>
        </View>)}
        {/* {!editMode && (<View style={styles.rowContainer}>
          <View style={{width: '50%', flex: 1, flexDirection: 'row'}}>
        ...
        {tenderDetail?.officialInvitation == true && !editMode && (<View style={styles.rowContainer}>
          ...
          <View style={{width: '50%', flex: 1, flexDirection: 'row'}}>
            {tenderDetail?.bankGuranteeValue!=null && (<Text style={styles.rowContentText}>{`${tenderDetail?.bankGuranteeCurrencySymbol}. ${tenderDetail?.bankGuranteeValue}`}</Text>)}
          </View>
        </View>)}
        {tenderDetail?.officialInvitation == true && !editMode && (<View style={styles.rowContainer}>
          <View style={{width: '50%', flex: 1, flexDirection: 'row'}}>
        ...
        {tenderDetail?.officialInvitation == true && !editMode && (<View style={styles.rowContainer}>
          ...
          <View style={{width: '50%', flex: 1, flexDirection: 'row'}}>
            {tenderDetail.clientReference!=null && (<Text style={styles.rowContentText}>{`${tenderDetail?.clientReference}`}</Text>)}
          </View>
        </View>)}
        {tenderDetail?.officialInvitation == true && !editMode && (<View style={[styles.rowContainer,{flexDirection: 'column'}]}>
          ...
          {tenderDetail.detailDescription!=null && (<Text style={[styles.rowContentText, {marginVertical: AppDimensions.NORMAL}]}>{`${tenderDetail?.detailDescription}`}</Text>)}
        </View>)}
        {!editMode && (<View style={[styles.rowContainer, {borderBottomWidth: 0}]}>
          <View style={{width: '50%', flex: 1, flexDirection: 'row'}}>
            <Text style={styles.rowTitleText}>Reference</Text>
          </View>
          <View style={{width: '50%', flex: 1, flexDirection: 'row'}}>
      ...
      {!editMode && tenderDetail?.officialInvitation == true && (<TouchableOpacity
      ...
      {console.log("Tender Detail", tenderDetail)}
      ...
      {!editMode && (<View style={[styles.titleView, {borderBottomWidth: 0.4, borderTopWidth: 0.4, marginVertical: AppDimensions.SMALL, paddingVertical: AppDimensions.NORMAL}]}>
          <Text style={styles.titleText}>ROTO</Text>
      </View>)}
          ...
          <View style={{marginVertical: AppDimensions.NORMAL}}>
            <View style={{flexDirection: 'row', marginVertical: AppDimensions.NORMAL, justifyContent: 'space-between'}}>
              <View style={{flexDirection: 'row'}}>
                ...
                <Text style={{width: '50%'}}>A/S Linjebygg</Text>
              </View>
            </View>
            <View style={{flexDirection: 'row', marginVertical: AppDimensions.NORMAL, justifyContent: 'space-between'}}>
              <View style={{flexDirection: 'row'}}>
                <Text style={{width: '50%'}}>Stage:</Text>
                <Text style={{width: '50%'}}>{`${tenderDetail.tenderStageName}`}</Text>
              </View>
            </View>
            <View style={{flexDirection: 'row', marginVertical: AppDimensions.NORMAL, justifyContent: 'space-between'}}>
              <View style={{flexDirection: 'row'}}>
            ...
            style={{alignItems: 'center'}}>
              {!showMore && (<View 
                  style={{padding: AppDimensions.NORMAL, borderRadius: moderateScale(20),backgroundColor: AppColors.ACCENT}}>
                <Text
                  style={{color: AppColors.NORMAL_WHITE}}>
                  Show More
                </Text>
              </View>)}
            </TouchableOpacity>
