        ...
        <View style={styles.tagContainer}>
          <View
            style={{
              ...styles.label,
              borderColor:
                item?.leaveApplicationCurrentStatusDto?.statusSystemName ===
                'Approved'
                  ? AppColors.TAG_GREEN
                  : item?.leaveApplicationCurrentStatusDto?.statusSystemName ===
                    'Pending'
            ...
            <Text
              style={{
                ...
                color:
                  ...
                  'Approved'
                    ? AppColors.TAG_GREEN
                    : item?.leaveApplicationCurrentStatusDto
                        ?.statusSystemName === 'Pending'
                    ? AppColors.WARNING_YELLOW
                    : AppColors.TAG_RED,
              }}>
              {item?.leaveApplicationCurrentStatusDto?.statusDisplayName}
            </Text>
          </View>
